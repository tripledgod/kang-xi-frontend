  ...
  return (
    <footer className="bg-[#201F1C] text-[#FDFBF1] pt-12 pb-12 px-4">
      <div className="flex flex-col items-center">
            ...
            <div className="flex flex-row justify-center gap-x-8 w-full md:w-auto md:gap-x-12">
              {navLinksRow1.map((link) => (
                <Link
                  key={link.label}
                  to={link.href}
                  className="text-[14px] leading-[20px] font-semibold text-[#FFFFFF] whitespace-nowrap opacity-80"
                >
                  {link.label}
                </Link>
              ))}
        ...
        {/* Faint divider line */}
        <div
          className="w-full max-w-[337px] mx-auto border-t border-[#F7F3E8]/20 opacity-50 md:mb-6 mb-8 md:max-w-7xl"
