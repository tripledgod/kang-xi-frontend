  ...
  return (
    <div className="relative w-full h-[260px] md:h-[340px] flex items-center justify-center overflow-hidden mb-12">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-20">
        <h1 className="hidden md:block text-white text-[60px] leading-[72px] font-semibold drop-shadow-lg text-center" style={{ letterSpacing: '-0.02em' }}>
          {cover?.title || 'About Us'}
        </h1>
        <h3 className="text-white text-[40px] leading-[48px] font-semibold drop-shadow-lg text-center md:hidden" style={{ letterSpacing: '-0.01em' }}>
          {cover?.title || 'About Us'}
        </h3>
