...
function RelatedArticles({ related }: { related: RelatedArticle[] }) {
  ...
  return (
    <section className="w-full py-16 px-4">
      <h2 className="text-4xl font-serif font-medium text-[#7B6142] mb-12 text-center">Related Articles</h2>
  ...
  return (
    <div className="w-full min-h-screen bg-[#F7F5EA]">
      <div className="max-w-2xl mx-auto px-4 pt-8">
        <div className="text-xs text-[#7B6142] font-semibold uppercase tracking-wider mb-2">JULY 4, 2024</div>
        <h1 className="text-3xl md:text-4xl font-serif font-semibold text-[#2E2A24] mb-2 leading-tight">They used to say that Yuan Blue-White Ceramics don't exist. How was it then discovered?</h1>
        ...
        <h2 className="text-xl font-serif font-semibold text-[#2E2A24] mb-2 mt-8">Chinese ceramics and the world of arts</h2>
        <p className="mb-6 text-[#23211C]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque euismod, urna eu tincidunt consectetur, nisi nisl aliquam nunc, eget aliquam massa nisl quis neque. Etiam euismod, urna eu tincidunt consectetur, nisi nisl aliquam nunc, eget aliquam massa nisl quis neque.</p>
        <img src={authorImg} alt="Author" className="w-full h-auto rounded mb-8" />
        <p className="mb-6 text-[#23211C]">Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Pellentesque euismod, urna eu tincidunt consectetur, nisi nisl aliquam nunc, eget aliquam massa nisl quis neque. Etiam euismod, urna eu tincidunt consectetur, nisi nisl aliquam nunc, eget aliquam massa nisl quis neque.</p>
        ...
        <p className="mb-6 text-[#23211C]">Aliquam erat volutpat. Pellentesque euismod, urna eu tincidunt consectetur, nisi nisl aliquam nunc, eget aliquam massa nisl quis neque. Etiam euismod, urna eu tincidunt consectetur, nisi nisl aliquam nunc, eget aliquam massa nisl quis neque.</p>
      </div>
